...
One commonly applied method is the **Lennard-Jones** potential model {% cite lennard-jones_determination_1924 %}, which considers the attractve London dispersion effects as follows, 
...
The values of $A$ and $B$ are those associated with an argon-argon interaction, as defined by Rahman {% cite rahman_correlations_1964 %}.
...
The Python code below allows the comparison between these two van der Waals potentials, using defined parameters for the argon-argon interaction {% cite rahman_correlations_1964 buckingham_classical_1938 %}.
